  ...
  <div class="tm-pay-page">
    <div class="container">
      <tm-bread>
        ...
        <tm-bread-item>支付结果</tm-bread-item>
      </tm-bread>
      <!-- 支付结果 -->
      <div class="pay-result">
        ...
        <div class="btn">
          <tm-button @click="$router.push('/member/order')" type="primary" style="margin-right: 20px;">查看订单</tm-button>
          <tm-button type="gray">进入首页</tm-button>
        </div>
        <p class="alert">
          <span class="iconfont icon-tip"></span>
          温馨提示：天猫商城不会以订单异常、系统升级为由要求您点击任何网址链接进行退款操作，保护资产、谨慎操作。
        </p>
      </div>
    </div>
  </div>
