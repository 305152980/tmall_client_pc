<template>
  <div class="goods-relevant">
    ...
    <!-- 此处使用改造后的 tm-carousel.vue。 -->
    <tm-carousel :sliders="sliders" />
  </div>
</template>
...
.goods-relevant {
  ...
  .header {
    ...
    .icon {
      ...
      border-top: 4px solid @tmColor;
      border-right: 4px solid @tmColor;
